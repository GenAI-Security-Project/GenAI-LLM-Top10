...
- *Check Point Research*: [ChatGPT Data Leakage via a Hidden Outbound Channel in the Code Execution Runtime](https://research.checkpoint.com/2026/chatgpt-data-leakage-via-a-hidden-outbound-channel-in-the-code-execution-runtime) (Fixed Feb 2026, published Mar 2026)
- *Check Point Blog*: [When AI Trust Breaks: The ChatGPT Data Leakage Flaw That Redefined AI Vendor Security Trust](https://blog.checkpoint.com/research/when-ai-trust-breaks-the-chatgpt-data-leakage-flaw-that-redefined-ai-vendor-security-trust) (Mar 2026)
- *The Hacker News*: [Claude Extension Flaw Enabled Zero-Click XSS Prompt Injection](https://thehackernews.com/2026/03/claude-extension-flaw-enabled-zero.html) (Mar 2026)
- *Palo Alto Unit 42*: [Taming Agentic Browsers: Vulnerability in Chrome Allowed Hijacking Gemini Live](https://unit42.paloaltonetworks.com/gemini-live-in-chrome-hijacking) — CVE-2026-0628 (Mar 2026)
- *The Guardian*: [Claude's Code: Anthropic Leaks Source Code for AI Software](https://www.theguardian.com/technology/2026/apr/01/anthropic-claudes-code-leaks-ai) (Apr 2026)
- *Fortune*: [Anthropic Mistakenly Leaks Its Own AI Coding Tool's Source](https://fortune.com/2026/03/31/anthropic-source-code-claude-code-data-leak-second-security-lapse-days-after-accidentally-revealing-mythos) (Mar 2026)
- *SecurityWeek*: [Critical Vulnerability in Claude Code Emerges Days After Source Leak](https://www.securityweek.com/critical-vulnerability-in-claude-code-emerges-days-after-source-leak) (Apr 2026)
- *Wiz Research*: [Wiz Research Uncovers Exposed DeepSeek Database Leaking Sensitive Information](https://www.wiz.io/blog/wiz-research-uncovers-exposed-deepseek-database-leak) (Jan 2025)
- *Wired*: [Exposed DeepSeek Database Revealed Chat Prompts and Internal Data](https://www.wired.com/story/exposed-deepseek-database-revealed-chat-prompts-and-internal-data) (Jan 2025)
- *Medium/Instatunnel*: [Differential Privacy Reversal via LLM Feedback: The Silent Threat](https://medium.com/@instatunnel/it-162aee1dbfe5) (2026)
- *arXiv*: [Data-Free Privacy-Preserving for LLMs via Model Inversion](https://arxiv.org/html/2601.15595v1) (Jan 2026)
- *arXiv*: [Towards Privacy-Preserving LLM Inference via Covariant Obfuscation (AloePri)](https://arxiv.org/html/2603.01499v2) (Mar 2026)
- *ScienceDirect*: [Security and Privacy in LLMs: A Comprehensive Survey of Threats](https://www.sciencedirect.com/science/article/pii/S156625352600120X) (2026)
...
- *Forbes*: [How Federated Learning Is Revolutionizing Data Security](https://www.forbes.com/councils/forbestechcouncil/2026/03/24/the-future-of-ai-privacy-how-federated-learning-is-revolutionizing-data-security) (Mar 2026)
- *AI Security and Safety*: [Differential Privacy for AI: Protecting Training Data (2026)](https://aisecurityandsafety.org/es/guides/differential-privacy-ai) (Mar 2026)
...
- *OWASP Top 10 for Agentic Applications (2026)*: [ASI06 - Memory Poisoning](https://genai.owasp.org/resource/owasp-top-10-for-agentic-applications-for-2026) — Addresses persistent agent memory corruption leading to data leakage
- *OWASP Agent Memory Guard*: [Protecting AI Agents from Memory Poisoning](https://owasp.org/www-project-agent-memory-guard) — Framework for securing persistent agent memory against injection and cross-session data harvesting
- *OWASP API8:2023*: [Security Misconfiguration](https://owasp.org/API-Security/editions/2023/en/0xa8-security-misconfiguration/) — Prevents leaking sensitive information through error messages or configuration details
- *EU AI Act (2026 Enforcement)*: [Regulatory Framework for AI](https://digital-strategy.ec.europa.eu/en/policies/regulatory-framework-ai) — Mandates data protection impact assessments for high-risk AI systems
- *IEEE S&P 2026*: [Accepted Papers on Privacy-Preserving Computation and LLM Security](https://sp2026.ieee-security.org/accepted-papers.html)
- *NeurIPS 2025*: [Setting Epsilon is Not the Issue in Differential Privacy](https://neurips.cc/virtual/2025/poster/121922) — Position paper on DP parameter selection and limitations
