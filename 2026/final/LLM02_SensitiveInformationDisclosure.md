...
**1. Training-data memorization and extraction.** The November 2023 "poem" divergence attack drove `gpt-3.5-turbo` to emit more than 10,000 unique memorized examples for roughly USD 200; vendor patches have been bypassed repeatedly. LoRA adapters are a separate, high-fidelity extraction surface (Wang et al., 2025), and fine-tuned models are markedly more extractable than base models of the same scale. Litigation exhibits (NYT v. OpenAI, Getty v. Stability AI, Kadrey v. Meta) supply direct evidence of verbatim reproduction of copyrighted and watermarked material.
