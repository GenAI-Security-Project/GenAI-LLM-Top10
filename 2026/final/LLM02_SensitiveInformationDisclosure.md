...
5. **Cross-entry coordination.** On revisions touching §2.7 (RAG), §3 (Embedding), §4 (Multimodal), §5 (Side channels), §6 (Pipeline), or §7 (Platform/Ecosystem), notify sub-teams for LLM01, LLM04, LLM05, LLM03, LLM08, LLM09, ASI, and the DSGAI working group as applicable.
