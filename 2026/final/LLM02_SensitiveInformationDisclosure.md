...
* **Pointers to sibling entries (2026 numbering):**
  ...
  * **LLM08:2026 System Prompt Leakage** — extraction of system-prompt text as such. This entry treats only cases where the extracted material contains PII, credentials, or regulated data (i.e., the system prompt was misused as a data store).
